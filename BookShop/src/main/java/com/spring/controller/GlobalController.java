...
public class GlobalController {
	...
	public void get_list_kr(@RequestParam(value = "keyword", required = false) String keyword,
	...
	public void get_list_jp(@RequestParam(value = "keyword", required = false) String keyword,
	...
	public void get_list_us(@RequestParam(value = "keyword", required = false) String keyword,
			@RequestParam(value = "category", required = false) String category, Model model)
			throws Exception {
		logger.info("book/list - GET POST");
		String country = "us";
